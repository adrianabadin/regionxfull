...
exports.authRoutes.post("/signup", (0, auth_schema_1.validateSchemaMiddleware)(auth_schema_1.SignUpSchema), passport_1.default.authenticate("register", { failureRedirect: "/login" }), (req, res) => { console.log(req.user); res.status(200).send(req.user); });
